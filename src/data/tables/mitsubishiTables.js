...
const mitsubishiEcoinverterHydrobox_6kW_base = [
  ...
  ['2', 'JEDNOSTKA ZEWNĘTRZNA SUZ-SWM60VA', 'szt.', '1'],
  [' ', 'ELEMENTY HYDRAULICZNE I ELEKTRYCZNE DO POMPY CIEPŁA', 'kpl.', '1'],
  [' ', 'Grupa bezpieczeństwa CWU (6bar)', 'szt.', '1'], // Zakładając, że jest potrzebna przy hydroboxie + zewnętrznym CWU
  [' ', 'Grupa bezpieczeństwa C.0 (2.5 bar)', 'szt.', '1'],
  [' ', 'Pompa obiegowa do instalacji grzewczej LFP ( z osprzętem )', 'szt.', '1'],
  [' ', 'MIEDŹ CHŁODNICZA', 'kpl.', '1'],
  [' ', 'REGULATOR BEZPRZEWODOWY MITSUBISHI PAR-WT', 'szt.', '1'],
...
const mitsubishiHP_4kW_base = [
  ['1', 'JEDNOSTKA WEWNĘTRZNA MITSUBISHI SUZ HYPER HEATING 4 kW ', 'szt.', '1'],
  ['2', 'JEDNOSTKA ZEWNĘTRZNA MITSUBISHI SUZ HYPER HEATING 4 kW ', 'szt.', '1'],
  [' ', 'ELEMENTY HYDRAULICZNE I ELEKTRYCZNE DO POMPY CIEPŁA', 'kpl.', '1'],
  [' ', 'Grupa bezpieczeństwa CWU (6bar)', 'szt.', '1'], // Zakładając, że jest potrzebna przy tej konfiguracji
  [' ', 'Grupa bezpieczeństwa C.0 (2.5 bar)', 'szt.', '1'],
  [' ', 'Pompa obiegowa do instalacji grzewczej LFP ( z osprzętem )', 'szt.', '1'],
  [' ', 'MIEDŹ CHŁODNICZA', 'kpl.', '1'],
  [' ', 'REGULATOR BEZPRZEWODOWY MITSUBISHI PAR-WT', 'szt.', '1'],
...
const mitsubishiHP_6kW_base = [
  ['1', 'JEDNOSTKA WEWNĘTRZNA MITSUBISHI SUZ HYPER HEATING 6 kW ', 'szt.', '1'],
  ['2', 'JEDNOSTKA ZEWNĘTRZNA MITSUBISHI SUZ HYPER HEATING 6 kW ', 'szt.', '1'],
  [' ', 'ELEMENTY HYDRAULICZNE I ELEKTRYCZNE DO POMPY CIEPŁA', 'kpl.', '1'],
  [' ', 'Grupa bezpieczeństwa CWU (6bar)', 'szt.', '1'], // Zakładając, że jest potrzebna przy tej konfiguracji
  [' ', 'Grupa bezpieczeństwa C.0 (2.5 bar)', 'szt.', '1'],
  [' ', 'Pompa obiegowa do instalacji grzewczej LFP ( z osprzętem )', 'szt.', '1'],
